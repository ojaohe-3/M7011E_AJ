...
use crate::{db::consumer_document::ConsumerDocument, handlers::weather_handler::WeatherReport};
...
impl Consumer {
    ...
    pub fn consumption(&self, temp: f64) -> f64 {
        ...
        self.profile * (0.002 * (294.15 - temp).powf(2.) + self.timefn[hour as usize]) / 3.6
        // kw
    }
